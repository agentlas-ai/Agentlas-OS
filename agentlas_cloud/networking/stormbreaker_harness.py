...
HARNESS_PROTOCOL_LINES = (
    ...
    "After each packet task is resolved, inherit its Agentlas Context Slice. Before mutation, query changed symbols/files through the reverse-reference impact map; do not rely on a blind tree scan.",
    ...
    "Before a packet or whole goal reports completion, require a passing Context Map impact receipt or report every unresolved affected file explicitly.",
