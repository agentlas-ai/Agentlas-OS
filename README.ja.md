...
| **Agentlas Hub** | エージェントを公開・発見・無料で利用できる場 |
...
*   **ワークスペースパーソナライゼーション:** 選択した Cloud/Hub エージェントのパーソナライゼーションログ（サマリー、プレイブック、プラグインロック、レシート）を、生のプロンプト・認証情報の値・プライベートファイルを保存することなく管理します。
