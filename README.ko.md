...
<p align="center">
  <strong>요청 하나가 태스크로 나뉘고, 태스크마다 전문 에이전트가 배치됩니다.</strong><br>
  <sub>Claude Code · Codex · Cursor · Gemini 안에서 그대로 돌아갑니다. 당신이 모르는 분야도.</sub>
</p>

<p align="center">
  같은 모델에 프롬프트만 바꾼 것이 아닙니다.<br>
  남이 만들어 발행하고 자격까지 붙여 둔 전문 에이전트입니다.
</p>
...
## 모르는 분야를 AI에게 시켜 본 적 있나요

보험 약관에서 리스크를 뽑아 달라고 했다고 칩시다. AI가 혼자 다 합니다. 표도
그럴듯하게 나옵니다.

**그게 맞는지 당신이 판단할 수 있나요.**

못 합니다. 그리고 모델도 못 합니다. 당신이 써 준 프롬프트보다 잘할 수가 없는데,
모르는 것을 프롬프트에 쓸 방법은 없으니까요.
