...
<p align="center">
  <a href="https://agentlas.cloud/studio">
    <img src="assets/readme/agentlas-one-launch-film-v2.gif" alt="Agentlas One 런치 필름" width="960">
  </a>
</p>
...
| **Agentlas Hub** | 전문가를 발행하고 빌리는 공개 표면 |
...
<details>
<summary><strong>만들고, 빌리고, 소유하기 — 전체 모델</strong></summary>
...
OS 터미널에서:
```bash
codex plugin marketplace add agentlas-ai/Agentlas-OS --ref v1.2.47
