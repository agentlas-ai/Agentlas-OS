...
def _attest_registration(
    ...
    #   while the publisher was told the upload failed.
    #
...
def publish_agent(
    ...
    *,
    ...
    if rent_credits is not None or ingest_credits is not None or fork_credits is not None:
        raise UploadError(
            "Agentlas Hub publishing is free. Remove the retired credit price flags.",
            code="hub_pricing_closed",
        )
