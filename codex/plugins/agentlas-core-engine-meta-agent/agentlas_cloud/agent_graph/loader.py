...
DEFAULT_GRAMMAR: dict[str, Any] = {
    ...
    "capabilities": [
        "create_single_agent",
        "create_single_agents",
        "build_agent_team",
        "build_agent_teams",
        "package_existing_agent",
        "package_existing_agents",
        "build_agents_from_sessions",
        "normalize_session_sources",
        "compile_session_ir",
        "repair_agent_repo",
        "repair_agent_repos",
        "generate_routing_cards",
        "verify_agent_packages",
        "publish_cloud_agents",
        "sync_runtime_adapters",
        "manage_memory_tickets",
        "coordinate_ontology_runtime",
        "run_normalize_session_sources",
        "run_compile_session_ir",
        "run_verify_agent_packages",
        "run_publish_cloud_agents",
        "run_sync_runtime_adapters",
        "run_manage_memory_tickets",
        "run_coordinate_ontology_runtime",
        "open_ontology_gui",
