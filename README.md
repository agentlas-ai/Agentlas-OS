...
From your OS terminal:
```bash
codex plugin marketplace add agentlas-ai/Agentlas-OS --ref v1.1.54
...
The v1.1.54 release contract ships and verifies a dependency-free
...
The v1.1.54 self-updater installs the complete one-touch runtime payload,
