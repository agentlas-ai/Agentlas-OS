...
- **Release metadata is consistent again.** Runtime manifests, MCP server
  ...
  docs, and tests now all point at v1.0.4.
...
- **Plugin mirrors stay aligned.** Claude Code and Codex mirrored plugin bundles
  carry the same v1.0.4 metadata as the root runtime.
...
```bash
codex plugin marketplace add agentlas-ai/Hephaestus --ref v1.0.4
