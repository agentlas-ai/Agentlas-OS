...
From your OS terminal:
```bash
codex plugin marketplace add agentlas-ai/Agentlas-OS --ref v1.1.42
...
The v1.1.42 release contract ships and verifies a dependency-free
...
The v1.1.42 self-updater installs the complete one-touch runtime payload,
